...
public class ExceptionHandler {
	...
	// @Autowired : Spring의 bean중에서 어노테이션이 지정된 레퍼런스의 타입에 맞는 빈을 찾아서 자동으로 주입
	// Aurtowired를 생성자에 선언부에 선언하면 생성자의 매개변수를 통해 의존성을 주입받게 된다.
	// Spring이 추천하는 방식은 생성자를 통해 필드를 주입받는 것을 권장
	
	// @Qualifier : @Autowired로 의존성 주입을 받을 때, 해당 타입의 빈이 여러개 있을 경우, 빈의 아이디를 사용해 특정빈을 주입
