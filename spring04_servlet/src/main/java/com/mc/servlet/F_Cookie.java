...
public class F_Cookie extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//			: default : 사이트의 context path가 된다. 따라서 사이트의 모든 페이지에 대한 요청에 쿠기가 담겨오게 된다.
		// http only : http-only로 지정된 쿠키는 자바스크림트에서 접근이 불가능
		//			 사용자의 페이지에 스크립트코드를 주입해서 공격하는 방식인 script injection 공격으로부터	
		//			 쿠리를 안전하게 사용하고 싶을 떄 지정
		...
		case "mysql":
			pw.println("<h2>mysql는 오라클사의 DBMS입니다.</h2>");
			break;

		case "html":
			pw.println("<h2>HTML은 웹페이지 제작을 위한 마크업언어입니다.</h2>");
			break;
		...
		case "javascript":
			pw.println("<h2>javascript는 프로토타입객체지향 프로그래밍 언어입니다.</h2>");
			break;
